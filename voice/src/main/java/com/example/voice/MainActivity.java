...
import com.example.voice.util.PermissionUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_speech_recognize).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.btn_speech_recognize) {
            if (PermissionUtil.checkPermission(this, new String[] {Manifest.permission.RECORD_AUDIO}, (int) v.getId() % 65536)) {
                startActivity(new Intent(this, SpeechRecognizeActivity.class));
            }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == R.id.btn_speech_recognize % 65536) {
