...
import com.example.network.bean.ImageMessage;
import com.example.network.bean.ImagePart;
import com.example.network.bean.JoinInfo;
import com.example.network.bean.MessageInfo;
import com.example.network.bean.ReceiveFile;
import com.example.network.util.BitmapUtil;
import com.example.network.util.ChatUtil;
